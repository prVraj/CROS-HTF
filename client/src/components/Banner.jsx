...
const Banner = () => (
  <section className="w-full h-screen bg-cover bg-center" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')` }}>
    <div className="w-full h-full bg-black bg-opacity-50">
      ...
      <div className="max-w-[1170px] mx-auto py-50 text-center text-white">
        <h1 className="sm:text-6xl text-4xl font-bold">Contactless Restaurant Ordering System</h1>
        <h4 className="text-xl py-4">A contactless restaurant ordering system revolutionizes the dining experience by leveraging technology to enhance convenience and safety for both customers and staff.</h4>
